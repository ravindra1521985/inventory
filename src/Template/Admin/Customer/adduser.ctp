              ...
              <div class="row paddLeft10 paddright10 mt-10" style="border-top:2px solid #ccc;">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">                      
                      <?php echo $this->Form->text('user_id', array('class'=>'form-control','maxlength'=>100,'placeholder'=>'Enter Name','id'=>'user_id','required','onkeyup'=>'checkuserid();','autocomplete'=>'off')); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">                      
                      <?php echo $this->Form->text('first_name', array('class'=>'form-control','maxlength'=>100,'placeholder'=>'Enter Name','id'=>'first_name', 'required')); ?>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">                      
                      <?php echo $this->Form->text('last_name', array('class'=>'form-control','maxlength'=>100,'placeholder'=>'Enter Name','id'=>'last_name', 'required')); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">                      
                      <?php echo $this->Form->text('mobile', array('class'=>'form-control numberp','maxlength'=>10,'placeholder'=>'Enter Phone','id'=>'mobile','required')); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">   
                      ...
                      echo $this->Form->select('group',$group,['id'=>'group','default'=>'2','empty'=>'Select Group','class'=>'form-control', 'required']); ?>                   
