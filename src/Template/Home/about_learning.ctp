...
<div class="page-content full flow">
                	<div class="container">
						...
						<?php  echo Ucfirst($value['heading']); ?></span></h3>
...
<p>
<?php  echo $this->Html->image('uploads/2017/02/'. $value['image'],['class'=>'alignnone wp-image-215 size-full', 'style'=>'
    float: right;
    height: 332px;
...
<?php echo $value['page_description']; ?>
