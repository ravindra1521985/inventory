        ...
        <?php echo $this->Form->error('first_name'); ?>
									...
									<?php echo $this->Form->error('last_name'); ?>
                                        ...
                                        <li class="state-city">
                                            ...
                                            <ul>
                                            	<li>												
												  <?php echo $this->Form->select('state',$state,['id'=>'state','default'=>'1','empty'=>'State','class'=>'listBox','child_id'=>'city',]); ?>										  
										...
										echo $this->Form->select('class',$class,['id'=>'class','default'=>'','empty'=>'Class']); ?><?php echo $this->Form->error('Class'); ?>
                                          ...
                                          <!--  <select name="class">
                                        	...
                                        	<label>Previous Shivir Attended </label>
                                            <ul>
                                            	<li><input type="checkbox" value="2012" name="c[]">2012</li>
                             ...
                             <?php echo $this->Form->end();?>
								...
								<Div style="color:red; text-align:center"><?php  echo $this->element(Frontend.'/session_flash_b'); ?></DIV>
